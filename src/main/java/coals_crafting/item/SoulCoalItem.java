...
public class SoulCoalItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:soul_coal")
	public static final Item block = null;
	public SoulCoalItem(CoalsCraftingModElements instance) {
		super(instance, 53);
	}
