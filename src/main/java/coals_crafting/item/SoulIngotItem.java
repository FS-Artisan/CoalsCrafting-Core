...
public class SoulIngotItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:soul_ingot")
	public static final Item block = null;
	public SoulIngotItem(CoalsCraftingModElements instance) {
		super(instance, 52);
	}
