...
public class BasisDiamondCoalItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:basis_diamond_coal")
	public static final Item block = null;
	public BasisDiamondCoalItem(CoalsCraftingModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("basis_diamond_coal");
		}
