...
public class SulphurItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:sulphur")
	public static final Item block = null;
	public SulphurItem(CoalsCraftingModElements instance) {
		super(instance, 50);
	}
