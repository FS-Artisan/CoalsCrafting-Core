...
public class BasisIronCoalItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:basis_iron_coal")
	public static final Item block = null;
	public BasisIronCoalItem(CoalsCraftingModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("basis_iron_coal");
		}
