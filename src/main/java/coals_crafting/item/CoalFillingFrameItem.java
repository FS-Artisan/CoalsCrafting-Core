...
public class CoalFillingFrameItem extends CoalsCraftingModElements.ModElement {
	@ObjectHolder("coals_crafting:coal_filling_frame")
	public static final Item block = null;
	public CoalFillingFrameItem(CoalsCraftingModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("coal_filling_frame");
		}
